...
echo -e "\033[1;36mwget https://raw.githubusercontent.com/yaelhdzuu/ssh/ADM-MANAGER-MOD-BY-YAEL/master/Install/apt-source.sh && chmod 777 ./* && ./apt-*"
echo -e "${cor[5]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -ne "\033[0m"
exit 1
}
...
wget -O trans https://raw.githubusercontent.com/yaelhdzuu/ssh/ADM-MANAGER-MOD-BY-YAEL/master/Install/trans -o /dev/null 2>&1
...
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e ""
echo -e "${cor[2]} $(source trans -b pt:${id} "")\n\033[1;37m  Script Modificado por: Yael Hernandez."
echo -e ""
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
...
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -ne "${cor[4]}"
wget -O lista https://raw.githubusercontent.com/yaelhdzuu/ssh/ADM-MANAGER-MOD-BY-YAEL/master/lista -o /dev/null
valid_fun
